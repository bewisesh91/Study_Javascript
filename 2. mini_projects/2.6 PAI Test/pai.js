...
// 결과 리스트
var result = {
    "I": {"title": "Innovative Style + ", "explain": "나는야 아이디어 뱅크! <br> 음... 과연 이게 최선일까? <br> 대담하게 새로운 길을 가자!!!", "img": "result2.png"},
    "A": {"title": "Innovative Style - ", "explain": "새로운 것 없을까?  <br> 합리적으로 생각해보자 <br> 내 속도로 변화를 만들거야!", "img": "result.png"},
